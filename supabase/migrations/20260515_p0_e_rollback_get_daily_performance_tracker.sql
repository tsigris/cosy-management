-- ============================================================
-- ROLLBACK: 20260515_p0_e_fix_get_daily_performance_tracker.sql
-- ============================================================
-- Apply ONLY to undo p0_e.
-- ⚠ Restores SECURITY DEFINER version without search_path or auth guard.
--   Any authenticated user can again read any store's performance data,
--   and the function is vulnerable to search_path poisoning.
