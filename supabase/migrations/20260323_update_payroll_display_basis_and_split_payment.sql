...
-- Recreate RPCs with additive payroll fields:
-- agreed_extra_salary, remaining_payroll_only, final_payable
...
begin
  ...
  if v_has_off_date then
    ...
    select
      ...
      case when b.monthly_days > 0 then ((b.monthly_salary + b.agreed_extra_salary) / b.monthly_days) else 0 end::numeric as daily_cost,
      case when b.monthly_days > 0 then ((b.monthly_salary + b.agreed_extra_salary) / b.monthly_days) / 8 else 0 end::numeric as hourly_cost,
