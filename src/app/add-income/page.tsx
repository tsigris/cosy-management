...
// 1. Το component που περιέχει όλη τη λειτουργία (μέσα στο Suspense)
function IncomeFormFields() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase.from('transactions').insert([
      { amount: parseFloat(amount), method, type: 'income', date_recorded: date }
    ])
...
// 2. Η κύρια σελίδα που "τυλίγει" τα παραπάνω με Suspense για το Vercel
