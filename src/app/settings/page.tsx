...
import { Settings, X, Download, Save, MessageCircle, Info, Monitor } from 'lucide-react'
...
function SettingsContent() {
  ...
  const fetchStoreSettings = useCallback(async () => {
    ...
    try {
      ...
      // ✅ Παίρνουμε τα στοιχεία απευθείας από τον πίνακα STORES (+ z_enabled)
    ...
    try {
      const { error } = await supabase
        ...
        .update({
          ...
          // ✅ NOTE: δεν χρειάζεται εδώ το z_enabled γιατί το σώζουμε instant
        })
        .eq('id', storeId)
    ...
    <div style={iphoneWrapper}>
      ...
      <div style={containerNarrow}>
        ...
        <div style={mainCardStyle}>
          ...
          <button onClick={handleProfileSave} disabled={profileLoading || profileSaveLoading} style={{ ...saveBtnStyle, marginBottom: 10 }}>
        ...
        <div style={mainCardStyle}>
          ...
          {/* ✅ NEW: Z TOGGLE CARD */}
          <div style={divider} />
          <p style={sectionLabel}>ΕΜΦΑΝΙΣΗ ΑΡΧΙΚΗΣ</p>
          ...
          <button
            ...
            style={{
              ...toggleRowBtn,
              opacity: zSaving ? 0.7 : 1,
            }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={toggleIconBox}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={pill(zEnabled ? '#059669' : '#e2e8f0', zEnabled ? '#ecfdf5' : '#0f172a')}>
                {zEnabled ? 'ON' : 'OFF'}
              </div>
          ...
          <div style={checkboxContainer}>
            ...
            <label htmlFor="exportAll" style={{ fontSize: '13px', fontWeight: '700' }}>
...
const mainCardStyle: any = { backgroundColor: 'white', padding: '24px', borderRadius: '24px', border: '1px solid #e2e8f0', boxShadow: '0 4px 10px rgba(0,0,0,0.03)', marginBottom: '14px' }
