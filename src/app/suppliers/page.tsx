...
function SuppliersContent() {
  ...
  const [bank, setBank] = useState('') // ✅ State για την τράπεζα
  ...
  const resetForm = () => {
    setName(''); setPhone(''); setAfm(''); setIban(''); setBank(''); setCategory('Εμπορεύματα');
  ...
  const handleSave = async () => {
    ...
    try {
      const supplierData = {
        ...
        bank: bank, // ✅ Προσθήκη στην αποθήκευση
        category: category,
                ...
                {expandedId === s.id && (
                  <div style={actionPanel}>
                    <div style={infoGrid}>
                      ...
                      <p style={infoText}><strong>Τράπεζα:</strong> {s.bank || '-'}</p>
...
// --- STYLES ΔΙΟΡΘΩΜΕΝΑ ΓΙΑ ΣΩΣΤΟ SCROLL ΠΑΝΤΟΥ ---
