...
function BalancesContent() {
  ...
  return (
    <div style={{ maxWidth: '500px', margin: '0 auto', padding: '16px', fontFamily: 'sans-serif', backgroundColor: '#f8fafc', minHeight: '100vh' }}>
      ...
      {/* ΣΥΝΟΛΙΚΟ ΧΡΕΟΣ (BLACK CARD STYLE) */}
...
const backBtnStyle = { 
  ...
  textDecoration: 'none', background: 'white', width: '40px', height: '40px', 
  borderRadius: '12px', fontSize: '20px', cursor: 'pointer', color: '#64748b',
  border: '1px solid #e2e8f0', fontWeight: 'bold' 
};

const totalCardStyle = { 
  backgroundColor: '#0f172a', padding: '25px', borderRadius: '24px', 
  marginBottom: '25px', textAlign: 'center' as const, color: 'white',
  boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)'
};

const supplierCardStyle = { 
  backgroundColor: 'white', padding: '18px', borderRadius: '20px', 
...
const payBtnStyle = { 
  ...
  fontWeight: '900' as const, marginTop: '8px', cursor: 'pointer' 
};

const badgeStyle = { 
  fontSize: '9px', fontWeight: '800' as const, backgroundColor: '#fff7ed', 
  color: '#c2410c', padding: '3px 8px', borderRadius: '6px', 
  textTransform: 'uppercase' as const, marginTop: '5px', display: 'inline-block' 
};
